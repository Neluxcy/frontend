      ...
      <nav className="relative flex items-center justify-between flex-wrap p-6">
        ...
        <div className={`w-full block flex-grow lg:flex lg:items-center lg:w-auto ${isOpen ? 'block' : 'hidden'}`}>
          <div className="text-sm lg:flex-grow">
            ...
            <Link href="/bidding_details" className="block mt-4 lg:inline-block lg:mt-0 transition-all duration-300 hover:bg-violet-800 hover:text-white mr-4 rounded-md p-1">
              Bid Notification
            </Link>
            <Link href="/help" className="block mt-4 lg:inline-block lg:mt-0 transition-all duration-300 hover:bg-violet-800 hover:text-white rounded-md p-1">
              Help
            </Link>
          </div>
